package com.hyperfield.remotehelp.toyvpn;
...
import com.hyperfield.remotehelp.R;
    ...
    public class ToyVpnService extends VpnService implements Handler.Callback {
        ...
        public static final String ACTION_CONNECT = "com.hyperfield.remotehelp.toyvpn.START";
        public static final String ACTION_DISCONNECT = "com.hyperfield.remotehelp.toyvpn.STOP";
...
//            final SharedPreferences prefs = getSharedPreferences(ToyVpnClient.Prefs.NAME, MODE_PRIVATE);
            final String server = "3.16.112.41";

            final byte[] secret = "test".getBytes();
