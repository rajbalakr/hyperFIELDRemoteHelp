...
import com.hyperfield.remotehelp.MainActivity
...
class ActionBarFragment : Fragment() {
    ...
    private val buttonClickListener = View.OnClickListener {
        when (it.id) {
            ...
            R.id.startVPN -> startVPNOnClickListener()
        }
    }
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        vpnButton = rootView.findViewById(R.id.startVPN) as ImageButton
        ...
        vpnButton.setOnClickListener(buttonClickListener)
    ...
    private fun startVPNOnClickListener() {
        vpnButton.setImageResource(if (!mainActivity.isCallInProgress) R.drawable.hang_up else R.drawable.ic_vpn)
        vpnButton.setBackgroundResource(R.drawable.background_icon)
        previewControlCallbacks?.onVPN()
    }
